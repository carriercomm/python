    ...
    def create_conf(self,appname):
        ...
        for filename in os.listdir(app_temp_dir):
            if filename == '81244006300012390.jks':
                ...
                #shutil.copytree(app_temp_dir+'/'+filename, app_conf_dir+'/'+filename)
            #print app_temp_dir+filename
            #elif os.path.isdir(app_temp_dir+'/'+filename):
            #    print 'hahahahahahhahahfhhhhhhhhhhh'
            else:
                #pass
