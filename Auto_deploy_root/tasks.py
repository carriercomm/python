...
class Deploy(object):
    ...
    def unzip_file(self,appname):
        ...
        if appname == 'cm' or appname == 'cm3':
            app_soft_dir = softs_path+'cm'
        elif appname == 'go2' or appname == 'carbiz3':
            app_soft_dir = softs_path+'go2'
        elif appname == 'rb' or appname == 'rb3':
            app_soft_dir = softs_path+'rb'
        elif appname == 'order' or appname == 'order3':
    ...
    def app(self,appname):
        ...
        if appname == 'order' or appname == 'order3':
            ...
            conf_dir = app_dict[appname]["dir"]+appname+self.dotime+"/conf/env/uat/"
