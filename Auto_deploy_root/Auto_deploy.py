...
def usage():
    ...
    --part3 'cm3 carbiz3 ...'
    --part4 'cm4 carbiz4 ...'
    example: python Auto_deploy.py -d --base 'cx cipm' --part1 'go2 cm' --part2 'cm2' ...
    '''
#主函数
if __name__ == "__main__":
        try:
            opts,args=getopt.getopt(sys.argv[1:],'drh',['help','base=','part1=','part2=','part3=','part4='])
